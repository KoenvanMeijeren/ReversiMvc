...
public class SetPasswordModel : PageModel
{
    ...
    public class InputModel
    {
        ...
        /// </summary>
        [Required]
        [StringLength(100, ErrorMessage = "Het wachtwoord {0} moet minimaal {2} en maximaal {1} karakters lang zijn.", MinimumLength = 6)]
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        this.StatusMessage = "Uw wachtwoord is ingesteld.";
