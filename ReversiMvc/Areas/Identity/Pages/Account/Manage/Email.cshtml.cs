    ...
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (this.Input.NewEmail != email)
            {
                ...
                this.StatusMessage = "Bevestigingslink is verstuurd om uw email te veranderen. Controleer uw email.";
                return this.RedirectToPage();
            }

            this.StatusMessage = "Uw email is niet veranderd.";
            return this.RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            this.StatusMessage = "Verificatie email verzonden. Controleer uw e-mail.";
            return this.RedirectToPage();
        }
    }
}
